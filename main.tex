...
58.9\% against 32.6\% for PubMed, the search researchers actually use today rather than
an idealized retrieval competitor.}
...
The comparison arm is PubMed, not a competing AI search product. This quadrant measures
Redpine Science against what a researcher actually does today, typing a question
straight into PubMed, rather than an idealized isolation against the most
sophisticated retrieval competitor available. Both arms receive the identical,
unmodified question text, no query engineering on either side.
...
Precision@5 at 58.9\% against 32.6\% for PubMed, the researcher's actual status quo
rather than an idealized retrieval competitor; a scaled-up
expert-validated answer set will be reported ahead of launch.
