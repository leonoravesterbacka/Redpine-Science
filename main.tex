...
\begin{tikzpicture}[
  ...
  tag/.style={font=\bfseries\footnotesize, text=RPCrimson},
]
  ...
  \node[panel, fill=RPWarmWhite] (j) at ([yshift=-5pt]g.south west)
    {{\tag Judge, one web-search answer}\\[2pt]
     ...
     coverage $C = 2/3$,\quad contradiction rate $K = 0$,\quad
     correctness $= 2 \cdot \tfrac{2}{3} \cdot 1 / (\tfrac{2}{3} + 1) = 0.80$};
\end{tikzpicture}
