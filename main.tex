...
\subsection{Quadrant two: expert-validated questions, answer quality}\label{sec:method-quadrant-two}
...
\subsection{Quadrant one: public benchmarks, answer quality}\label{sec:results-quadrant-one}
...
\subsection{Quadrant two: expert-validated questions, answer quality}\label{sec:results-quadrant-two}
...
Precision@5: Redpine [XX]\%, Exa [XX]\%. DCG@5: Redpine [XX.XX], Exa
[XX.XX].
